...
class Decoder(BaseModule):
    ...
    def __init__(self, code_length, deepest_shape, output_shape):
        ...
        self.conv = nn.Sequential(
            ...
            nn.Conv2d(in_channels=16, out_channels=c, kernel_size=1, bias=False)
        )
...
class LSA_CIFAR10(BaseModule):
    ...
    def __init__(self,  input_shape, code_length, K=3, num_blocks =1, hidden_size= 2048, k=5, r=4, est_name = None):
