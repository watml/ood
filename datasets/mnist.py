...
class MNIST(BaseDataset):
    def __init__(self, path, n_class=10, InD=None):
        ...
        self.train_split = datasets.MNIST(self.path, train=True, download=True, transform=transforms.ToTensor())
        self.test_split = datasets.MNIST(self.path, train=False, download=True, transform=transforms.ToTensor())
    ...
    def __repr__(self):
        return ("OOD detection on MNIST (InD = {} )").format(self.InD)