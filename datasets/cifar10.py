...
class CIFAR10(BaseDataset):
    def __init__(self, path, n_class=10, InD=None, train_intra=True):
        ...
        self.train_split = datasets.CIFAR10(self.path, train=True, download=True, transform=transforms.ToTensor())
        self.test_split = datasets.CIFAR10(self.path, train=False, download=True, transform=transforms.ToTensor())
    ...
    def __repr__(self):
        return ("OOD detection on CIFAR10 (InD = {} )").format(self.InD)