...
class CIFAR100(BaseDataset):
    def __init__(self, path, n_class=10, InD=None):
        ...
        self.train_split = datasets.CIFAR100(self.path, train=True, download=True, transform=transforms.ToTensor())
        self.test_split = datasets.CIFAR100(self.path, train=False, download=True, transform=transforms.ToTensor())
    ...
    def __repr__(self):
        return ("OOD detection on CIFAR100 (InD = {} )").format(self.InD)